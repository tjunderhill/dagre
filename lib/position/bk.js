...
function sep(nodeSep, edgeSep, reverseSep, clusterpaddingtop, clusterpaddingbottom) {
  return function(g, v, w) {
    ...
    const vPadding = vLabel.borderType === "borderRight" ? clusterpaddingbottom : clusterpaddingtop;
    const wPadding = wLabel.borderType === "borderRight" ? clusterpaddingbottom : clusterpaddingtop;
